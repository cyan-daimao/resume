...
const projectsData: Record<string, ProjectData> = {
  'cyan-dataman': {
    id: 'cyan-dataman',
    title: 'Cyan DataMan',
    subtitle: '一站式数据治理与智能分析平台',
    description:
      '面向企业数据团队的一站式数据中台，覆盖元数据管理、指标定义、SQL 探索、数据工场、BI 可视化与 ChatBI 智能问答等全链路能力。',
    tags: ['React', 'TypeScript', 'Vite', 'Ant Design', 'ECharts', 'Monaco Editor'],
    color: '#38bdf8',
    icon: <Database className="w-8 h-8" />,
    kpis: [
      { value: '10+', label: '核心模块' },
      { value: '50+', label: '数据源接入' },
      { value: '< 200ms', label: '查询响应' },
      { value: '99.9%', label: '系统可用性' },
    ],
    overview:
      'Cyan DataMan 是一个企业级数据治理与智能分析平台，旨在打通数据从接入到消费的全链路。平台采用前后端分离架构，前端基于 React + TypeScript + Vite 构建，提供流畅的交互体验和丰富的可视化能力。',
    features: [
      {
        title: '元数据管理',
        desc: '统一管理数据表、字段、主题、数据源等元信息，支持表血缘追踪、数据质量监控与数据预览。',
        icon: <Table2 className="w-5 h-5" />,
      },
      {
        title: '指标中心',
        desc: '规范化指标定义与管理，涵盖指标字典、维度管理、分析看板与配置管理，确保口径一致。',
        icon: <BarChart3 className="w-5 h-5" />,
      },
      {
        title: 'SQL 探索',
        desc: '内置 Monaco Editor 的 SQL 编辑器，支持语法高亮、智能提示、结果面板与多标签管理。',
        icon: <Code2 className="w-5 h-5" />,
      },
      {
        title: '数据工场',
        desc: '可视化的数据任务编排与调度，支持任务实例管理与执行结果追踪。',
        icon: <Workflow className="w-5 h-5" />,
      },
      {
        title: 'BI 可视化',
        desc: '基于 ECharts 的图表与大屏设计器，支持拖拽式布局、多维度筛选与仪表盘发布。',
        icon: <Monitor className="w-5 h-5" />,
      },
      {
        title: 'ChatBI 智能问答',
        desc: '自然语言驱动数据分析，通过大模型将用户提问自动转化为 SQL 与可视化图表。',
        icon: <Sparkles className="w-5 h-5" />,
      },
    ],
    techStack: [
      { category: '前端框架', items: ['React 18', 'TypeScript', 'Vite'] },
      { category: 'UI 组件', items: ['Ant Design 5', 'React Grid Layout'] },
      { category: '可视化', items: ['ECharts 6', 'echarts-for-react'] },
      { category: '代码编辑', items: ['Monaco Editor', '@monaco-editor/react'] },
      { category: '状态管理', items: ['Zustand'] },
      { category: '路由', items: ['React Router v7'] },
      { category: '网络请求', items: ['Axios'] },
      { category: '样式方案', items: ['Less'] },
    ],
    highlights: [
      '采用模块化设计，各功能域解耦，支持按需加载与独立部署',
      '自研 SQL 编辑器深度集成 Monaco，支持语法高亮与自定义主题',
      'BI 大屏基于 react-grid-layout 实现拖拽式自由布局',
      '统一封装 Axios 请求层，支持请求拦截、错误处理与自动重试',
      '组件化开发，沉淀 20+ 可复用业务组件，提升团队开发效率',
    ],
    links: [
      {
        label: '查看源码',
